...
class robot:
    ...
    def move(self, motionv): # Do not change the name of this function
        ...
        bot_prime = robot(self.length)
        bot_prime.set(x_prime, y_prime, orientation_prime)
        bot_prime.set_noise(bearing_noise, steering_noise, distance_noise)
        #return bot_prime
        
        return bot_prime # make sure your move function returns an instance
