...
def doit(initial_pos, move1, move2):
    ...
    omega = omega.expand(1, 1, [], [])
    omega.value[0][0] = 1
    xhi =  xhi.expand(1, 1, [], [])
    xhi.value[0][0] = initial_pos

    ## move 1
    omega = omega.expand(2, 2, [0], [0])
    xhi = xhi.expand(2, 1, [0])
    ...
    ## move 2
    omega = omega.expand(3, 3, [0, 1], [0, 1])
    xhi = xhi.expand(3, 1, [0, 1], [0])
    ...
    ## omega inverse times xhi = state matrix
    mu = omega.inverse() * xhi
    return mu
