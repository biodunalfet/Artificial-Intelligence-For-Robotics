...
#COULDN'T SOLVE THIS. MEASUREMENT WERE JUST TOO NOISY!!! GOODLUCK TO EVERYONE WHO TRIES THIS PROBLEM
def hnext_move(hunter_position, hunter_heading, target_measurement, max_distance, OTHER = None):
...
def next_move(hunter_position, hunter_heading, target_measurement, max_distance, OTHER = None):
    ...
    #print "target " + str(target_measurement)
    ...
    if OTHER == None:
        ...
        OTHER = [[target_measurement], [], [], "centre", [], None, 0]
        turning = 0
        distance = 0
        ...
        mode = OTHER[3]
        trap_from = OTHER[4]
        xy_estimate, EXTRA_OTHER = lbestimate_next_pos(target_measurement, OTHER[5])
        OTHER[5] = EXTRA_OTHER
        ...
        if len(OTHER[0]) < 100:
            ...
            if mode == "chase":
                #xy_estimate, N_OTHER = lbestimate_next_pos(target_measurement, NEW_OTHER)
                ...
                if distance_between(hunter_position, target_measurement) > max_distance * 2:
                    mode = "centre"
                ...
                #print distance_between(hunter_position, target_measurement)
                if distance_between(hunter_position, target_measurement) <= max_distance * 4:
                    count += 1
                    OTHER[6] = count
                    if count >= 2:
                        mode = "chase"
...
def xdemo_grading(hunter_bot, target_bot, next_move_fcn, OTHER = None):
