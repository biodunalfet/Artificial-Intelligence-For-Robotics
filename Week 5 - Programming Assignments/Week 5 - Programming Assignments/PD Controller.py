...
def run(param1, param2, color):
    ...
    #print myrobot.move(steering, 0.01)
    
    x = [0]
    y = [0]
    for i in range(N):
        plt.plot(x, y , color)
        diff_CTE = myrobot.y - CTE_old
        CTE_old = myrobot.y
        steering = -param1 * myrobot.y - param2 * diff_CTE
        ...
        print myrobot, steering, diff_CTE
